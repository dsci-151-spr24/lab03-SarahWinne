...
For each category, there are more people in the US than other. 
...
```{r nobel_living_scienctist_country_count}
...
```{r nobel_plot_living_country_and_birthplace}
...
The graphs do support the articles claim that many noble laureats, though based in the US, were born in other countries. This is shown by the significant chunk of red(those born in not the US) in the USA country for how many nobel laureats there are(to the point where those born in other countries either outnumber those born in the US for three of the graphs).
...
```{r nobel_plot_living_country_not_us_count}
...
***Germany is the most common with 20, followed by Japan and the UK***
